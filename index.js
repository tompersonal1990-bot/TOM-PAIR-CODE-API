...
// Global memory allocation to keep active pairing sockets alive in background
...
bot.onText(/\/pair/, async (msg) => {
    ...
    try {
        ...
        await bot.editMessageText(`❌ *API Error:* Request timed out or connection instance lost. Please try again.`, {
            chat_id: chatId,
            message_id: waitingMsg.message_id,
            parse_mode: 'Markdown'
        });
