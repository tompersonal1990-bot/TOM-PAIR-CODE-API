/**
 * TOM PRIME X BOT - Clean Integrated Pairing Code Server & Telegram Bot
...
app.get('/pair', async (req, res) => {
    ...
    try {
        ...
        // নোটিফিকেশন ট্রিগার করার জন্য অপ্টিমাইজড সকেট কনফিগারেশন
        ...
        // ক্রেড সেভ করার লিসেনার
        XeonBotInc.ev.on('creds.update', saveCreds);

        // কানেকশন লিসেনার (মেমোরি সেভ করার জন্য)
